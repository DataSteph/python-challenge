...
# candidatelist = []
# print(candidatelist)
print(title,file=open('Election Results.txt',"a"))
print(title)
print("-"*35, file=open('Election Results.txt',"a"))
print("-"*35)
print('Total Votes: ' + str(len(Voter_ID)), file=open('Election Results.txt',"a"))
print('Total Votes: ' + str(len(Voter_ID)))
print("-"*35, file=open('Election Results.txt',"a"))
print("-"*35)
print('Correy: ' + c + ' ' + '(' + str(Candidate.count("Correy")) + ')', file=open('Election Results.txt',"a"))
print('Correy: ' + c + ' ' + '(' + str(Candidate.count("Correy")) + ')')
print('Li: ' + l + ' ' + '(' + str(Candidate.count("Li")) + ')', file=open('Election Results.txt',"a"))
print('Li: ' + l + ' ' + '(' + str(Candidate.count("Li")) + ')')
print('Khan: ' + k + ' ' + '(' + str(Candidate.count("Khan")) + ')', file=open('Election Results.txt',"a"))
print('Khan: ' + k + ' ' + '(' + str(Candidate.count("Khan")) + ')')
print("O'Tooley: " + o + ' ' + '(' + str(Candidate.count("O'Tooley")) + ')', file=open('Election Results.txt',"a"))
print("O'Tooley: " + o + ' ' + '(' + str(Candidate.count("O'Tooley")) + ')')
print("-"*35, file=open('Election Results.txt',"a"))
print("-"*35)
winner = Candidate.most_common(1)
print('Winner: ' + winner)
```